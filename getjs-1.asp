...
function insert_credit() {
	$('.sidebar').append('<p class="theme_credit"><a href=""></a>All artwork © Marius Langerak<a href=""></a>.</p>');
}
});
...
;(function($) {
 ...
 newa.setAttribute("href","http://themecloud.co/themes/stacky-5/");
 ...
 newimg.setAttribute("style","position:absolute; right:3px; top:25px;z-index:99999999;");
